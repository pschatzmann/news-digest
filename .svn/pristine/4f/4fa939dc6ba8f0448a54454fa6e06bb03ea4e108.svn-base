...
public class TestDocumentStore {
	...
	public void testStreamCount()  {
		System.out.println(store.stream("publisher_t:(guardian)").count());
	}
	...
	public void testPagedDocuments() {
		List<PagedDocuments> pages = store.pagedDocuments("publisher_t:(guardian)");
	...
	public void testCount() {
		long count = store.count("publisher_t:(guardian)");
